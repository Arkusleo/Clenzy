...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _loadProfile() async {
    ...
    try {
      ...
      // Failed to load, rely on basic properties
              ...
              _buildMenuItem(
                ...
                onTap: () async {
                  await Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) =>
                          EditProfileScreen(initialData: _userProfile),
                    ),
                  );
                  _loadProfile(); // Reload profile when returning
                },
              ),
              _buildMenuItem(
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              gradient: (_profileImage == null && _userPhotoUrl == null)
                  ? LinearGradient(
    ...
    return Container(
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: [const Color(0xFFB8D4E8), const Color(0xFF8BB8D4)],
        ),
      ),
      child: Center(
        child: Text(
