  ...
  Widget _buildTransactionItem(Map<String, dynamic> transaction) {
    ...
    return GestureDetector(
          ...
          MaterialPageRoute(
            builder: (context) => TransactionDetailsScreen(
              transaction: {
                ...
                'type': transaction['isPositive'] ? 'earning' : 'withdrawal',
      ...
      child: Container(
        ...
        color: Colors.transparent, // Ensures taps hit the whole row
        child: Row(
          children: [
            // Icon
            Container(
            ...
            Column(
              ...
              children: [
                Text(
                  '${transaction['isPositive'] ? '+' : '-'}\$${(transaction['amount'] as num).toStringAsFixed(2)}',
                  style: TextStyle(
                    fontSize: 15,
                    fontWeight: FontWeight.bold,
