...
import '../profile/worker_professional_details_screen.dart';
import '../profile/worker_service_areas_screen.dart';
import '../profile/worker_notification_settings_screen.dart';
import '../profile/worker_help_support_screen.dart';
import '../profile/worker_about_screen.dart';
          ...
          children: [
                    ...
                    child: ClipOval(
                      child: _profileImage != null
                          ? FutureBuilder<List<int>?>(
                              future: _profileImage!.readAsBytes().then(
                                (b) => b.toList(),
                              ),
            ...
            Container(
              ...
              child: Row(
                mainAxisSize: MainAxisSize.min,
                children: const [
                  Icon(Icons.star, color: Color(0xFF3366FF), size: 16),
                  SizedBox(width: 4),
                  Text(
                    '4.8 (124 reviews)',
                    style: TextStyle(
            ...
            Container(
              ...
              child: Column(
                children: [
                  ...
                  _buildDivider(),
                  _buildMenuItem(Icons.map_outlined, 'Service Areas', () async {
                    await Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const WorkerServiceAreasScreen(),
                      ),
                    );
                    setState(() {});
                  }),
                  ...
                  _buildMenuItem(
                    ...
                    () {
                      Navigator.push(
                        ...
                        MaterialPageRoute(
                          builder: (context) =>
                              const WorkerNotificationSettingsScreen(),
                        ),
                      );
                    },
                  ),
                ...
                children: [
                  ...
                  _buildMenuItem(Icons.info_outline_rounded, 'About', () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => const WorkerAboutScreen(),
                      ),
                    );
                  }),
                ],
