...
class _PartnerOnboardingScreenState extends State<PartnerOnboardingScreen> {
  ...
  Future<void> _submitForApproval() async {
    ...
    try {
      ...
      // Call API to mark profile as complete in backend/localstorage
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        leading: IconButton(
          icon: const Icon(Icons.close, color: Color(0xFF1A1D26)),
          ...
          Container(
            ...
            child: TextField(
              ...
              decoration: InputDecoration(
                hintText:
                    'E.g., Master plumber with over 10 years of experience specializing in residential leak repairs, fixture installations, and emergency maintenance...',
            ...
            child: Column(
              ...
              children: [
                ...
                TextField(
                  ...
                  decoration: _buildInputDecoration(
                    'E.g., Senior Plumber, Electrician',
                  ),
                ),
                const SizedBox(height: 24),
